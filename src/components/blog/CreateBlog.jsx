                ...
                {this.state.isSubmitted ? (
                    ...
                    <div className="container mt-4">
                        ...
                        <div className="row animated slideInLeft">
                            <div className="col">
                                <h2 className="text-success font-weight-bold">Create a blog</h2>
                                <p className="lead">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus hic rem officiis
                                    omnis ab aut alias magni maxime eos exercitationem. Nihil consectetur officia ex
